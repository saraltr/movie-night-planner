...
})({"kQBY0":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "dd19112a50f081e5";
"use strict";
...
var _resultsListMjs = require("./resultsList.mjs");
(0, _resultsListMjs.displayMovies)();

},{"./resultsList.mjs":"hMHhX"}],"hMHhX":[function(require,module,exports) {
...
if (searchTerm == null) searchTermElement.textContent = "Sorry, we couldn't find any results. Try again!";
else searchTermElement.textContent = `Search term: ${searchTerm}`;
searchContainer.appendChild(searchTermElement);
async function displayMovies() {
    try {
        const results = await (0, _externalServicesMjs.fetchMovieBySearch)(searchTerm);
...
function resultsTemplate(movies) {
    if (!movies || !movies.Search || !Array.isArray(movies.Search)) return "<p>No movies found</p>";
...
},{}]},["kQBY0","fwhxG"], "fwhxG", "parcelRequireac40")

//# sourceMappingURL=results.50f081e5.js.map
